"""
Django settings for pcmortgage project.
...
SECRET_KEY = 'vwm^@ytk(n!p4vt55dzbpu!7ksj69$6*g2zdwcy_m2s_g1x6@y'
...
WSGI_APPLICATION = 'pcmortgage.wsgi.application'
